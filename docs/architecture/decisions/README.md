...
| [ADR-003](ADR-003-parallel-stt-validation.md) | superseded | STT 병렬 검증 제안, ADR-006으로 대체 |
...
| [ADR-006](ADR-006-on-premise-gpu-inference.md) | accepted | 보유 GPU를 활용한 온프레미스 모델 추론, GPU 임대는 미정 |
